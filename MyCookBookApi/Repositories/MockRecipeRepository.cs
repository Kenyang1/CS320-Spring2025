            ...
            return _recipes
                .Where(r =>
                    (string.IsNullOrEmpty(searchRequest.Keyword) ||
                     r.Name.Contains(searchRequest.Keyword, System.StringComparison.OrdinalIgnoreCase) ||
                     r.Summary.Contains(searchRequest.Keyword, System.StringComparison.OrdinalIgnoreCase)) &&
